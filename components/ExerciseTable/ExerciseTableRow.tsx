...
export default function ExerciseTableRow({ exerciseId, index, set, onEditExerciseSet, onDeleteExerciseSet, isDeleteExerciseDisabled }: IExerciseTableRowProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.dataCell}>
        <Title keyboardType="decimal-pad" disabled={isDeleteExerciseDisabled || isSetDisabled} isEditable style={[styles.title, styles.editableTitle]} onChangeText={(text) => setExerciseSet({ ...exerciseSet, weight: text })} onBlur={handleSetBlur}>{exerciseSet.weight}</Title>
      </View>
      <View style={styles.dataCell}>
        <Title keyboardType="decimal-pad" disabled={isDeleteExerciseDisabled || isSetDisabled} isEditable style={[styles.title, styles.editableTitle]} onChangeText={(text) => setExerciseSet({ ...exerciseSet, reps: text })} onBlur={handleSetBlur}>{exerciseSet.reps}</Title>
      </View>
      <View style={styles.actionCell}>
        <IconButton disabled={isDeleteExerciseDisabled || isSetDisabled} iconName="remove-circle-outline" onPress={handleDeleteExerciseSet} />
      </View>
    </View>
  );
}

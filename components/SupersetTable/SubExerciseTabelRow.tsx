...
export default function SubExerciseTabelRow({ exerciseId, index, set, onEditExerciseSet, onDeleteExerciseSet, isDeleteSupersetDisabled, isUnlinkExerciseDisabled, isUnlinkAllExercisesDisabled, isMoveDisabled, isDeleteExerciseDisabled, isCreateNewExerciseDisabled, isLinkExerciseDisabled }: ISubExerciseTabelRowProps) {
